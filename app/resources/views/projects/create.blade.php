<x-app-layout>
    <x-slot name="header">Новый проект</x-slot>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8">
            ...
            <form class="space-y-6" action="{{ route('projects.store') }}" method="POST">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" name="name" type="text" value="{{ old('name') }}" placeholder="Название проекта"/>
                ...
                <div class="flex items-center justify-end gap-4 pt-2">
                    ...
                    <x-primary-button>Создать проект</x-primary-button>
                </div>
