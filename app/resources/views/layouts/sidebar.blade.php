        ...
        <ul class="space-y-2">
            <li>
                ...
                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('projects.create') }}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Create Project</a>
                    </li>
                    <li>
                        <a href="{{route('projects.index')}}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Show Projects</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul id="dropdown-authentication" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('profile.edit') }}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                            Change Password or View Profile
                        </a>
                    </li>
                    <li>
